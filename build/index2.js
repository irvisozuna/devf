...
var _clients = require('./src/schemas/clients');
...
_mongoose2.default.connect('mongodb://root:Poiu0987*@ds121593.mlab.com:21593/backend');
...
app.get('/userlist', function (req, res) {
    _clients2.default.find({}).then(function (users) {
        res.send(users);
    });
});
...
app.get('/add-client', function (req, res) {
    var client = new _clients2.default({
        name: "CLIENTAZO",
...
app.get('/find-client', function (req, res) {
    ...
    _clients2.default.find({ 'name': 'CLIENTAZO' }).then(function (clients) {
        res.send(clients);
    });
});
