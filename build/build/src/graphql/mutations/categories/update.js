...
exports.default = {
    ...
    resolve: function resolve(root, params) {
        return _categories2.default.findByIdAndUpdate(params.id, { $set: _extends({}, params.data) }).then(function (category) {
            return _categories2.default.findById(category.id).exec();
        }).catch(function (err) {
